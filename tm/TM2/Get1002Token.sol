...
contract Get1002Voken is Ownable, Pausable {
    ...
    IVoken public VOKEN = IVoken(0xE79AF1D5f6Db9c54F4C09288795740ee439C625a);
    IVokenPublicSale public VOKEN_PUBLIC_SALE = IVokenPublicSale(0xEDe36A8a35b698894Cb2Cf0F069f094193013802);
    ...
    function () external payable whenNotPaused {
        ...
        (__etherPrice, , , __vokenUsdPrice, , , , , , , ,) = VOKEN_PUBLIC_SALE.status();
         ...
         require(__etherPrice > 0, 'ether price  < 0');
       ...
       // require(VOKEN.transfer(msg.sender, VOKEN_PER_TXN), ' transfer failure!');
    }
}